...
namespace Game.ColoredCharsControlsLibrary {
    public sealed class MulticoloredStringsTextboxControl : ColoredCharsControl {
        ...
        /// </summary>
        public MulticoloredStringsTextboxControl(MulticoloredString[] text) : base() {
            if (text is null) {
        ...
        /// </summary>
        public MulticoloredStringsTextboxControl(MulticoloredString text) {
            if (text is null) {
                throw new ArgumentNullException(nameof(text));
            }
